...
const STRINGS = {
  zh: {
    ...
    community_create: '＋ 发新帖',
    compose_hint: '👇 直接在这里写，加图片/视频后点「发布」—— 不用弹窗',
    compose_hint_login: '👇 先点右上角登录，再在这里写内容发帖',
    login_for_post: '请先登录再发帖',
    ...
    stat_authors: '作者',
    post_submit: '发布',
    post_modal_title: '发新帖',
    post_title_ph: '标题（可选）…',
    post_content_ph: '碎碎念、repo、想说不敢说的…',
    post_tags_ph: '#今日心情 #追星碎碎念',
    post_toast: '已发到树洞',
    post_toast_scroll: '发布成功！向下滚动可看到你的帖',
    post_toast_fail: '发布失败，稍后再试',
    post_toast_server: '服务器未就绪，请刷新后重试',
    post_posting: '发布中…',
    ...
    media_added: '已选 {n} 张图片',
    video_added: '已选 1 个视频，点「发布」上传',
    media_processing: '正在处理图片…',
    media_pick_fail: '图片未选中，请重试或换一张',
    err_img_size: '单张图片不能超过 10MB',
    err_video_size: '视频不能超过 25MB，请剪短或用相册里的「存储优化」',
    guest_alt: '未登录',

    login_title: '入站登记',
    login_desc: '登记昵称后即可发帖、留评论、开雷达',
    post_empty_hint: '写点内容，或添加图片/视频',
    login_nickname: '昵称',
    login_email: '邮箱（可选）',
  ...
  en: {
    ...
    compose_hint: '👇 Write here, add media, tap Publish — no popup needed',
    compose_hint_login: '👇 Log in (top right), then write and publish here',
    login_for_post: 'Please log in to post',
    ...
    media_added: '{n} image(s) selected',
    video_added: '1 video selected — tap Publish',
    media_processing: 'Processing image…',
    media_pick_fail: 'No image selected — try again',
    err_img_size: 'Images must be under 10MB',
    err_video_size: 'Videos must be under 25MB — trim or use a shorter clip',
